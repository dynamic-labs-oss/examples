...
export default function DynamicButton() {
  ...
  useEffect(() => {
    ...
    dynamicClient.wallets.getNetwork({ wallet: evmAccount })
      .then((r) => setActiveNetworkId(String(r.network)))
    ...
    return (
      <div className="relative" ref={dropdownRef}>
        <button
          ...
          style={{ borderColor: "#DADADA", color: "#030303", background: "#fff" }}
        >
          <span
          ...
          >
            {step !== "networks" ? (
              <>
                ...
                <button
                  onClick={() => { setShowDropdown(false); setStep("idle"); disconnect(); }}
                  className="cursor-pointer w-full text-left px-4 py-3 text-sm transition-colors hover:bg-[#F9F9F9]"
                  style={{ color: "#606060" }}
                >
                  Disconnect
              ...
              <div className="p-3 space-y-2" style={{ minWidth: "14rem" }}>
                ...
                <p className="text-xs font-medium pb-1" style={{ color: "#030303" }}>Select network</p>
                ...
                {evmNetworks.map((n) => (
                  <button
                    ...
                    className="cursor-pointer w-full flex items-center gap-2 px-3 py-2 rounded-lg text-sm transition-colors hover:bg-[#F9F9F9] disabled:opacity-50"
                    style={{
                      color: "#030303",
                      background: activeNetworkId === String(n.networkId) ? "#F0F0F0" : "transparent",
                    }}
                  >
                    ...
                    {n.name}
                    {activeNetworkId === String(n.networkId) && (
