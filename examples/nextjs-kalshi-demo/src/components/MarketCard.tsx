...
const TAG_COLORS: Record<string, string> = {
  trending: "bg-[#F0F0F0] text-[#606060] border-[#DADADA]",
  hot: "bg-[#F0F0F0] text-[#606060] border-[#DADADA]",
  new: "bg-[#F0F0F0] text-[#606060] border-[#DADADA]",
  "ending soon": "bg-[#F0F0F0] text-[#606060] border-[#DADADA]",
  "high stakes": "bg-[#F0F0F0] text-[#606060] border-[#DADADA]",
  "close call": "bg-[#F0F0F0] text-[#606060] border-[#DADADA]",
};
...
export function MarketCard({
  ...
  const cardContent = (
    <motion.div
      layout
      className={`bg-white border border-[#DADADA] shadow-sm rounded-[22.837px] w-full relative ${
        isExpanded ? "z-50" : "z-0"
      }`}
      style={
            ...
            <div className="box-border content-stretch flex flex-col gap-[13.702px] items-start p-[15.986px] relative w-full">
              <div className="content-stretch flex gap-[9.135px] items-start relative shrink-0 w-full">
                ...
                <div className="basis-0 content-stretch flex flex-col gap-[9.135px] grow items-start min-h-px min-w-px relative shrink-0">
                  <div className="bg-[#EBEBEB] overflow-clip relative rounded-[7px] shrink-0 size-[45.675px]">
                    {imageUrl ? (
                      ...
                      <div className="absolute bg-[#EBEBEB] left-0 size-[45.675px] top-0 flex items-center justify-center">
                        <span className="text-lg">📊</span>
                      </div>
                    )}
                  </div>
                  <p
                    className={`leading-[22.837px] not-italic relative shrink-0 text-[#030303] text-[18.27px] tracking-[0.1827px] font-semibold ${
                ...
                <div className="content-stretch flex gap-[9.135px] h-[27.405px] items-center justify-end relative shrink-0 w-[80px]">
                  <div className="content-stretch flex gap-[4.567px] items-center overflow-clip relative shrink-0">
                    <ClockIcon />
                    <p className="leading-[18.27px] not-italic relative shrink-0 text-[13.702px] text-[#606060] text-nowrap tracking-[0.137px] whitespace-pre font-medium">
                      {timeRemaining}
                    </p>
                  </div>
                </div>
              ...
              {yesTraders !== undefined && noTraders !== undefined && (
                <div className="bg-[#F9F9F9] border border-[#DADADA] h-[80px] relative rounded-[12px] shrink-0 w-full">
                    ...
                    <div className="absolute bg-[#F9F9F9] bottom-0 box-border content-stretch flex flex-col items-start justify-between left-0 p-[8px] top-0 w-[100px]">
                      ...
                      <div className="content-stretch flex flex-col gap-[4px] items-start relative shrink-0 w-full">
                        ...
                        <div className="bg-[#14b8a6]/10 box-border content-stretch flex flex-col gap-[4px] h-[18px] items-center justify-center px-[8px] py-[6px] relative rounded-[20px] shrink-0 min-w-[51px]">
                          <div className="flex flex-col justify-center leading-0 not-italic relative shrink-0 text-[#14b8a6] text-[9px] text-nowrap font-semibold">
                        ...
                        <div className="bg-[#ef4444]/10 box-border content-stretch flex flex-col gap-[4px] h-[18px] items-center justify-center px-[8px] py-[6px] relative rounded-[20px] shrink-0 min-w-[42px]">
                          <div className="flex flex-col justify-center leading-0 not-italic relative shrink-0 text-[#ef4444] text-[9px] text-nowrap font-semibold">
                            <p className="leading-[13px] whitespace-nowrap">
                              No {noPrice}%
                            </p>
                          </div>
                      ...
                      {/* Volume Display */}
                      <div className="flex flex-col justify-center leading-0 not-italic relative shrink-0 text-[#606060] text-[10px] text-nowrap font-medium">
                  ...
                  <div
                    aria-hidden="true"
                    className="absolute border-[#DADADA] border-[0.5px] border-solid inset-0 pointer-events-none rounded-[12px]"
                  />
                </div>
              )}
            </div>
                ...
                >
                  <div className="flex flex-row items-center justify-center size-full">
                    <div className="box-border content-stretch flex gap-[22.837px] items-center justify-center px-[22.837px] py-[11.419px] relative size-full">
                      <div
                        className={`flex flex-col justify-center leading-0 not-italic relative shrink-0 text-[15.986px] text-nowrap text-right font-semibold ${
                          selectedOption === "yes"
                            ? "text-[#0a0b0f]"
                            : "text-[#14b8a6]"
                        }`}
                ...
                {isExpanded && (
                  ...
                  >
                    <div className="content-stretch flex flex-col gap-[11px] items-start w-full">
                      {/* Input Field */}
                      <div className="bg-[#F9F9F9] h-[48px] relative rounded-[10px] shrink-0 w-full border border-[#DADADA]">
                        <div className="flex flex-row items-center size-full">
                          <div className="box-border content-stretch flex h-[48px] items-center justify-between pl-[12px] pr-[11px] py-[12px] relative w-full">
                            ...
                            <div className="content-stretch flex flex-col items-start justify-center relative flex-1">
                              <div className="content-stretch flex gap-[6px] items-center relative shrink-0">
                                <input
                                  ...
                                  placeholder="$0"
                                  className="leading-[normal] text-[#4779FF] text-[20px] tracking-[-0.2px] bg-transparent border-none outline-none w-full placeholder:text-[#4779FF] placeholder:opacity-30 font-medium"
                                />
                              </div>
                            </div>
                            ...
                            <div className="content-stretch flex gap-[5px] items-center relative shrink-0">
                              ...
                              >
                                <p className="leading-[16px] relative shrink-0 text-[#606060] text-[14px] text-center text-nowrap whitespace-pre font-medium">
                                  +5
                                </p>
                              </motion.button>
                              <motion.button
                                ...
                                className="bg-[#EBEBEB] content-stretch flex gap-[10px] h-[25px] items-center justify-center relative rounded-[16px] shrink-0 w-[36px] cursor-pointer hover:bg-[#DADADA]"
                              >
                                <p className="h-[16px] leading-[16px] relative shrink-0 text-[#606060] text-[14px] text-center text-nowrap whitespace-pre font-medium">
                                  +10
                                </p>
                              </motion.button>
                            </div>
                      ...
                      {tradingSuccess && (
                        <div className="bg-[#14b8a6]/10 border border-[#14b8a6]/30 rounded-[10px] p-[12px] w-full">
                          <p className="text-[#14b8a6] text-[14px] font-medium">
                      ...
                      >
                        <div className="flex flex-col items-center justify-center overflow-clip rounded-[inherit] size-full">
                          ...
                          >
                            <p className={`relative shrink-0 font-bold ${betAmount > 0 && !isProcessing ? "text-white" : "text-[#606060]"}`}>
                              {isProcessing
                                ? "Processing..."
                                : !solanaAccount
                                ? "Connect Wallet"
                            ...
                            {betAmount > 0 && !isProcessing && (
                              <p className="relative shrink-0 text-white/70 font-medium">
                  ...
                  <div className="box-border content-stretch flex flex-col gap-[13.702px] items-start p-[15.986px] relative w-full">
                    <div className="content-stretch flex gap-[9.135px] items-start relative shrink-0 w-full">
                      <div className="basis-0 content-stretch flex flex-col gap-[9.135px] grow items-start min-h-px min-w-px relative shrink-0">
                        ...
                        <p className="leading-[22.837px] min-w-full not-italic relative shrink-0 text-[#030303] text-[18.27px] tracking-[0.1827px]">
                          {question}
                        </p>
                      </div>
                    </div>
